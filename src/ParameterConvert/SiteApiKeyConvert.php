...
namespace Drupal\site_api_key\ParameterConvert;
...
class SiteApiKeyConvert implements ParamConverterInterface {
  ...
  public function convert($value, $definition, $name, array $defaults) {
    // We must use 'convert' as the name of function as this is defined by 
    // an Interface.
    // Return Value when SiteApiKey is same as URL argument.
    if ($value == $this->configFactory->get('site_api_key.settings')->get('siteapikey')) {
      return $value;
    }
  ...
  public function applies($definition, $name, Route $route) {
    // We must use 'applies' as the name of function as this is defined by 
    // an Interface.
